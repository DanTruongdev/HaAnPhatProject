    ...
    public partial class initialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EnquiryId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WarehouseLogId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarehousLogs", x => x.WarehouseLogId);
                    table.ForeignKey(
                        name: "FK_WarehousLogs_Models_ModelId",
                        column: x => x.ModelId,
                        principalTable: "Models",
                        principalColumn: "ModelId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WarehousLogs_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Họa tiết trang trí" });

            migrationBuilder.InsertData(
                table: "Collections",
                columns: new[] { "CollectionId", "CollectionName", "Description", "Thumbnail" },
                values: new object[] { 1, "Bộ dụng cụ 1", "Bộ dụng cụ xử lí kính 2 trong 1", null });

            migrationBuilder.InsertData(
                table: "Colors",
                columns: new[] { "ColorId", "ColorName", "Image" },
                values: new object[,]
                {
                    { 1, "Xanh", null },
                    { 2, "Vàng", null },
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ProductCode", "ProductName", "Sold", "VoteStar" },
                values: new object[] { 1, 1, "PR1", "Sản phẩm test", 0, 0.0 });

            migrationBuilder.InsertData(
                table: "Models",
                columns: new[] { "ModelId", "Available", "ColorId", "Description", "ModelName", "PrimaryPrice", "ProductId", "SecondaryPrice", "Specification", "UnitId" },
                values: new object[] { 1, 0, 1, "Đây là phần mô tả sản phẩm", null, 500.0, 1, 400.0, null, 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehousLogs_ModelId",
                table: "WarehousLogs",
                column: "ModelId");

            migrationBuilder.CreateIndex(
                name: "IX_WarehousLogs_UserId",
                table: "WarehousLogs",
                column: "UserId");
        }
